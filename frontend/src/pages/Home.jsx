...
export default function Home() {
  ...
  useEffect(()=>{
    ...
    const observer = new IntersectionObserver(iframObserverCallback,{threshold:0.1})
  if(iframeRef.current){
    observer.observe(iframeRef.current)
}
return()=>{ if (iframeRef.current) {
  ...
  return (
    ...
    <div  ref={iframeRef}style={{ width: '100%' ,height:300,display:'grid',placeItems:'center' }} >
      {!isVisible?<SpinnerComponent />:    
      <iframe
        title="vimeo-player"

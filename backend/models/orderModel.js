...
const orderSchema = new mongoose.Schema({
  ...
  products: [
    {
      ...
      price: {
        ...
        min: [0, '{VALUE}- Price must be a positive number'],
      },
    },
  ],
  shippingAddress: {
  ...
  trackingNumber: {
    ...
    validate: {
      validator: (val) => validator.isAlphanumeric(val, 'en-US', { ignore: '-,#_' }),
      message:
        '{VALUE}- Tracking number must only contain english characters and without - , # _.',
    },
  },
  createdAt: {
    type: Date,

...
export default function PopularProductsSidbarItem({
  ...
  const handleItemClick = () => setSelectedCategory(name);

  return (
    <Sidebar.Item
      onClick={handleItemClick}
      className={`text-emerald-500 flex items-center justify-between w-full ${
        selectedCategory === textToShow
          ? 'bg-gray-200 border border-emerald-300'
          : ' bg-gray-100'
